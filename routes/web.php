...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/disable/enable', 'EventController@isdisable');


    Route::get('/tickets', 'EventController@tickets')->name('tickets');
    Route::get('/viewTicket', 'EventController@viewTickets')->name('viewTicket');
    Route::post('/insert/tickets', 'EventController@insertTickets')->name('issue-tickets');
